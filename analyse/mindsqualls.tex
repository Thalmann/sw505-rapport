...
\mikkel{Jeg kunne ikke finde på en bedre titel :/}
...
\mikkel{Indsæt billede af robotten evt?}

\begin{lstlisting}[style=csharpsmall,caption={Et eksempel på et \mindsqualls program},label=mindsqualls:example]
