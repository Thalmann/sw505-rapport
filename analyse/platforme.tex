...
Ens for alle API'er der benytter sig af standard firmware, er at de sender kommandoer til at styre NXT'en. \stefan{Er det sandt for alle standard firmware API'er? Også dem vi ikke har prøvet?}
