...
\item Funktionens opdaterings hastighed var ikke tilfredsstillinde (\mikkel{Indsæt fps}).
...
Ved lave opdaterings hastigheder bliver ændringerne i robottens lokation for høje (robotten flytter sig op til \mikkel{Indsæt tal} cm mellem to billeder).
\end{enumerate}

\mikkel{Indsæt evt. billede af tracking}
