...
\begin{axis}[
  ...
  ytick={0,0.5,1}, yticklabels={$l_{free}$,$l_0$,$l_{occ}$},
  ...
  \addplot [very thick,cyan!50!black, domain=4:6] {gauss(4, 0.4, 6, 0.7)};
  \addplot [very thick,cyan!50!black, domain=6:8] {gauss(6, 0.7, 8, 0.5)};
