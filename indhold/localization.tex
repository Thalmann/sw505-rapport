...
\subsection{Kinect }
Microsofts Kinect benytter et RGB farvekamera samt en dybdesensor til at fortolke bevægelse som input i applikationer.
...
\thilemann{giver det mening at opsummere kinect her, når nu der findes et kæmpe afsnit om det?}
...
For det første havde vi adgang til en Kinect hvilket gjorde valget oplagt og for det andet, gør det medfølgende SDK det let at arbejde med Kinecten.

%\clearpage
\section{Omregning fra punkt i billede til reelt punkt}
