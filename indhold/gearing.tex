...
Dette afsnit fokuserer på den gearing, der er monteret på de ultrasoniske sensorer, som kan ses i \cref{robot:opbygning}\renewcommand{\thefootnote}{\fnsymbol{footnote}}\footnote{En model over robotten i LEGO Digital Designer, kan ses i kildekoden (se \cref{kildekode}).}.
