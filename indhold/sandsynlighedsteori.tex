...
\thilemann{forklaring af ovenstående og nedenstående udledning}
...
Kædereglen er især nyttig ved beregninger af baysiske netværk og ved brug af \textit{Bayes Regel} (\cref{sandsynlighed:bayes_regel}).
