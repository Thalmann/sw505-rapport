...
\thilemann{Det er vel PC'en som 'henter' kommandoerne fra whalles outbox?}
\subsubsection*{NXC}
...
Dette gør det muligt at skrive et program til NXCen, hvorefter der kan udføres forskellige handlinger, afhængig af hvad PC'en beder den om.
