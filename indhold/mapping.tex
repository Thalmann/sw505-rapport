...
\begin{equation}
	\begin{split}
	\eta \bigint_{r-\rho}^{r+\rho} \frac{1}{\sqrt{2 \pi \big(\frac{\alpha}{6}\big)^2}}e^{- \frac{(z_t - z_t)^2}{2 (\frac{\alpha}{6})^2}}\, \mathrm{d}r &= l_{occ} \\
    \implies \eta &= \frac{l_{occ}}{\bigint_{r-\rho}^{r+\rho} \frac{1}{\sqrt{2 \pi \big(\frac{\alpha}{6}\big)^2}}e^{0}\, \mathrm{d}r} 
	\end{split}
\end{equation}
