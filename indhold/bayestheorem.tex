...
I tilfælde hvor tilstanden er statisk, for eksempel en verden uden bevægelige objekter som andre robotter eller personer.
Her kan en \textit{belief} på en given statisk tilstand beskrives som:
\begin{equation}
...
Opdateringsalgoritmen tager \textit{log odds} for en \textit{posterior belief} for en celle samt en ny sensor-måling, hvor ud fra der returneres en ny belief med \textit{log odds} af sandsynligheden for om hvorvidt cellen er optaget.
