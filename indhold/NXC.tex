...
Til at programmere robotten \thilemann{robotten? der menes vel bricken?} har vi valgt at benytte NXC; et programmeringssprog designet til NXT robotten. 
...
Da der skal kommunikeres med en Kinect sensor er det nødvendigt at kunne kommunikere med en PC fra NXT'en.\thilemann{Er dette første gang kinect nævnes? Hvis ja, så er den endnu ikke introduceret.}
