...
Nogle elementer er bevidst ikke implementeret på grund af tidsbegrænsning, og andre er gruppen kommet frem til, givet de erfaringer der er gjort i løbet af projektet. \thilemann{andre hvad? sætningen giver ikke helt mening?}
...
\thilemann{grunden til at vi kunne bruge color tracking var fordi vi placerede Kinecten i loftet}
...
Der er også et større udvalg af webcams, så det vil være muligt at finde et kamerea med en bedre opløsning, opdateringshastighed eller en anden parameter, der vil forbedre lokaliseringen.
\thilemann{de to første linjer bør omformuleres for at få den rette mening frem}
