\section{Lokalisering af robot}\label{tracking}
...
\thilemann{Bedre med subsections istedet for paragraffer nedenunder?}
...
\paragraph{Maksimal afstand}\label{tracking:maksimal_afstand}
