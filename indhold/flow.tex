...
For at vise hvordan arkitekturen (\cref{arkitektur}) \thilemann{mere specifik henvisning i stedet for til kapitlet selv?} benyttes, kommer der her et udvalgt eksempel, hvor det kan ses hvordan data traverserer gennem lagene i arkitekturen, ikke mindst kommunikationen mellem robot og PC.
