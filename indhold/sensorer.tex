...
\end{figure}
\thilemann{Motoren er ikke en sensor - navnet på kapitlet samt indledning henviser kun til at afsnittene handler om sensorer - der skal således skrives noget om motorer i indledningen.}
\thilemann{Louise: "Overskriften bør ændres så den dækker hele kapitlet, fx 'Sensorer og motorer'".}
\bruno{Det er rotationssensoren der testes i motoren.}
...
\thilemann{Jeg synes det er meget fint?}
