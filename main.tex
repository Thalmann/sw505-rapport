...
\thilemann{Whalle, en autonom robot til kortlægning af ukendte områder}
\thilemann{Whalle, kortlægning vha. autonom robot.}
...
\part[Teori]{Teori\\
	...
	\vspace{2cm}
	\normalsize{\textnormal{
		\textit{\input{indhold/indledning_teori}}
	}}
	\end{minipage}
}
...
\input{indhold/ruteplanlaegning}
...
\part[Konklusion]{Konklusion\\
	...
	\vspace{2cm}
	\normalsize{\textnormal{
		\textit{Denne del giver en evaluering af rapportens resultater ud fra målsætningen, samt en opsummering af indholdet. Slutteligt perspektiveres der over resultaterne med forslag til fremtidige forbedringer.\thilemann{review please}}
	}}
	\end{minipage}
}
\chapter{Evaluering}
...
\input{appendix/sequenceDiagrams}
