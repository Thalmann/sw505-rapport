...
\part[Bilag]{Bilag\\
	...
	\vspace{2cm}
	\normalsize{\textnormal{
		\textit{I denne del findes rapportens bilag. Først findes testresultaterne for sensorerne, og derefter kommer en delmængde af sekvensdiagrammet for flowet i systemet. Til sidst er en forklaring af hvordan github repositoriet hvor projektkoden er gemt i er opbygget.}
	}}
	\end{minipage}
}
